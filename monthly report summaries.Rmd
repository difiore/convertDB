...
## Set up observers, dates, taxa of interest, etc.
...
kable(output[,c(1:7)], digits = 1, caption="Observer Activity by Day")
...
kable(output_summary, digits = 1, caption="Observer Activity Summary")
```
